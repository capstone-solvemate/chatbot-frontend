...
export default function IkonTanggal(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      width="20"
      height="20"
      ...
      {...props}
    >
      <g clipPath="url(#clip0_1002_3288)">
        <path
          d="M6.66675 1.66699V5.00033"
          stroke="currentColor"
          strokeWidth="1.66667"
          strokeLinecap="round"
