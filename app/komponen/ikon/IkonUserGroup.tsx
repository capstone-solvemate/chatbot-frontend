...
export default function IkonUserGroup(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      width="16"
      height="16"
    ...
    >
      ...
      />
      <path
        d="M14.666 14.0002V12.6669C14.6656 12.0761 14.4689 11.5021 14.1069 11.0351C13.7449 10.5682 13.2381 10.2346 12.666 10.0869"
        stroke="currentColor"
        strokeWidth="1.33333"
        strokeLinecap="round"
        strokeLinejoin="round"
